...
impl BootValidator {
    ...
    pub fn validate_prerequisites(
        ...
        if let Some(mode) = config.graphics_mode {
            ...
            if mode.width > hw_info.graphics.max_width || mode.height > hw_info.graphics.max_height
            {
...
impl KernelLoader {
    ...
    pub fn load_kernel(
        ...
        let kernel_info =
            crate::domain::boot_config::KernelInfo::new(load_address, kernel_size, entry_point)?;
