...
use crate::utils::{
    error::{BootError, Result as BootResult},
    error_recovery::{ErrorRecoveryManager, ErrorSeverity, OutputMode, RecoveryStatus},
};
...
mod integration_tests {
    ...
    fn test_vga_initialization_recovery_flow() {
        ...
        // 应该降级到文本模式或串行控制台
        assert!(
            recovered_mode == OutputMode::TextMode || recovered_mode == OutputMode::SerialConsole
        );
