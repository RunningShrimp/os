...
impl BootError {
    ...
    pub fn as_error_code(&self) -> u32 {
        match self {
            ...
            BootError::InsufficientMemory => 0x2003,
            ...
            BootError::HardwareError(_) => 0x6002,
            ...
            BootError::ValidationError(_) => 0xA002,
            ...
            BootError::ServiceResolutionFailed(_) => 0x10001,
            BootError::EventError(_) => 0x10002,
            BootError::UefiNullSystemTable => 0x4003,
            BootError::UefiSystemTableNotInitialized => 0x4004,
            BootError::NotImplemented => 0xFFFF,
        }
    }
    ...
    pub fn description(&self) -> &'static str {
        match self {
            ...
            BootError::InsufficientMemory => "Insufficient memory available",
            ...
            BootError::ProtocolInitializationFailed(_) => "Protocol initialization failed",
            ...
            BootError::HardwareError(msg) => msg,
            ...
            BootError::ConfigurationError(_) => "Configuration error",
            BootError::ValidationError(_) => "Validation error",
            ...
            BootError::ServiceResolutionFailed(_) => "Service resolution failed",
            BootError::EventError(_) => "Event handling error",
            BootError::UefiNullSystemTable => "UEFI system table is null",
            BootError::UefiSystemTableNotInitialized => "UEFI system table not initialized",
            BootError::NotImplemented => "Function not implemented",
        }
    }
...
/// Convert from &'static str to bootloader error
impl From<&'static str> for BootError {
    fn from(msg: &'static str) -> Self {
        BootError::ConfigurationError(String::from(msg))
    }
}
...
macro_rules! boot_error {
    ($error:expr, $($arg:tt)*) => {
        $crate::utils::error::BootError::Generic(format_args!($($arg)*).as_str().as_ptr() as u32)
    };
}