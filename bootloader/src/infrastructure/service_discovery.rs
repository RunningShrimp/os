...
use crate::{
    infrastructure::di_container::{DIContainer, ServiceCondition},
...
impl ServiceDiscovery {
    ...
    pub fn register_service_type<T: 'static>(&mut self, service_name: &'static str) {
        self.discovered_services
            .insert(TypeId::of::<T>(), service_name);
    }
    ...
    pub fn generate_discovery_report(&self) -> String {
        ...
        for metadata in self.metadata_cache.values() {
            ...
            let protocols: Vec<String> = metadata
                .supported_protocols
                .iter()
                .map(|p| format!("{:?}", p))
                .collect();
...
impl ServiceRegistry for CoreServiceRegistry {
    fn register_services(&self, container: &mut DIContainer) -> Result<(), &'static str> {
        ...
        let _ = container.register_singleton(
            ...
            crate::infrastructure::di_container::HardwareDetectionServiceFactory::new(
                container.protocol_type(),
            ),
        ...
        let _ = container.register_singleton(
            "GraphicsBackend",
            crate::infrastructure::di_container::GraphicsBackendFactory::new(
                container.protocol_type(),
            ),
...
impl DIContainer {
    ...
    pub fn create_service_discovery(&self) -> ServiceDiscovery {
        ...
        // 注册核心服务元数据
        discovery.register_metadata(
            ServiceMetadata::new("HardwareDetectionService")
        ...
        discovery.register_metadata(
            ServiceMetadata::new("BootConfigRepository")
        ...
        discovery.register_metadata(
            ServiceMetadata::new("GraphicsBackend")
        ...
        discovery.register_metadata(
            ServiceMetadata::new("DomainEventPublisher")
...
mod tests {
    ...
    fn test_service_discovery() {
        ...
        // 注册元数据
        discovery.register_metadata(
            ServiceMetadata::new("TestService")
