...
fn benchmark_process_lookup(c: &mut Criterion) {
    ...
    c.bench_function("process_lookup_miss", |b| {
        b.iter(|| table.find_ref(black_box(9999)));
    });
}
