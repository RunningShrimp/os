...
use kernel::{
    microkernel::service_registry::{
        InterfaceVersion, ServiceCategory, ServiceInfo, ServiceRegistry, ServiceStatus,
    },
    tests::common::{IntegrationTestResult, integration_test_assert, integration_test_assert_eq},
};
...
pub fn test_service_start() -> IntegrationTestResult {
    ...
    let services = registry
        .find_service_by_name("test_service")
