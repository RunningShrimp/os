...
pub fn test_clone_thread() -> TestResult {
    ...
    let args = [
        (crate::posix::CLONE_VM
            | crate::posix::CLONE_FILES
            | crate::posix::CLONE_FS
            | crate::posix::CLONE_SIGHAND
...
pub fn test_clone_child_cleartid() -> TestResult {
    ...
    let args = [
        (crate::posix::CLONE_VM
            ...
            | crate::posix::CLONE_FS
            | crate::posix::CLONE_SIGHAND
            | crate::posix::CLONE_THREAD
            | crate::posix::CLONE_CHILD_CLEARTID) as u64,
        0u64,      // stack
        0u64,      // parent_tid_ptr
