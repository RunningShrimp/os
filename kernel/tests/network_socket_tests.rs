...
pub fn test_socket_creation() -> TestResult {
    ...
    let args = [
        ...
        crate::posix::SOCK_STREAM as u64, // type
    ...
    let args = [
        ...
        crate::posix::SOCK_STREAM as u64,
        0u64,
    ];
...
pub fn test_socket_bind() -> TestResult {
    ...
    let mut sockaddr =
        crate::posix::Sockaddr { sa_family: crate::posix::AF_INET as u16, sa_data: [0; 14] };
...
pub fn test_socket_listen() -> TestResult {
    ...
    let args = [
        fd as u64, 200u64, // backlog too large
    ];
