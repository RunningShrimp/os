...
impl Default for KeyModifiers {
    fn default() -> Self {
        Self { shift: false, control: false, alt: false, meta: false }
    }
}
...
impl InputManager {
    ...
    pub fn register_handler(
        ...
        handler: alloc::sync::Arc<Mutex<dyn InputEventHandler>>,
    ) -> Result<(), i32> {
...
pub fn get_input_manager() -> &'static InputManager {
    ...
    unsafe { &*(INPUT_MANAGER.lock().as_ref().unwrap() as *const InputManager) }
}
