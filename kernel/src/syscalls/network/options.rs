...
/// Set socket options
pub fn sys_setsockopt(args: &[u64]) -> super::super::common::SyscallResult {
    if args.len() < 5 {
...
/// Get socket options
pub fn sys_getsockopt(args: &[u64]) -> super::super::common::SyscallResult {
    if args.len() < 5 {
        return Err(SyscallError::InvalidArgument);
    }
    let fd = args[0] as i32;
...
/// Get socket name
pub fn sys_getsockname(_args: &[u64]) -> super::super::common::SyscallResult {
    // TODO: Implement getsockname syscall
    Err(SyscallError::NotSupported)
}

/// Get peer name
pub fn sys_getpeername(_args: &[u64]) -> super::super::common::SyscallResult {
