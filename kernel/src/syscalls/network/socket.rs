...
pub fn sys_socket(args: &[u64]) -> super::super::common::SyscallResult {
    if args.len() < 3 {
...
pub fn sys_bind(args: &[u64]) -> super::super::common::SyscallResult {
    if args.len() < 3 {
        return Err(SyscallError::InvalidArgument);
    }
...
pub fn sys_listen(args: &[u64]) -> super::super::common::SyscallResult {
    if args.len() < 2 {
        return Err(SyscallError::InvalidArgument);
    }
    let fd = args[0] as i32;
...
pub fn sys_accept(args: &[u64]) -> super::super::common::SyscallResult {
    if args.len() < 3 {
        return Err(SyscallError::InvalidArgument);
    }
    let fd = args[0] as i32;
...
pub fn sys_connect(args: &[u64]) -> super::super::common::SyscallResult {
    if args.len() < 3 {
        return Err(SyscallError::InvalidArgument);
    }
    let fd = args[0] as i32;
...
/// Shutdown a socket
pub fn sys_shutdown(args: &[u64]) -> super::super::common::SyscallResult {
    if args.len() < 2 {
        return Err(SyscallError::InvalidArgument);
    }
    let fd = args[0] as i32;
...
/// Create socket pair
pub fn sys_socketpair(_args: &[u64]) -> super::super::common::SyscallResult {
