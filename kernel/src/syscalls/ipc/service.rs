...
impl IpcService {
    ...
    pub fn create_pipe(&mut self, flags: u32) -> Result<(i32, i32), crate::syscalls::ipc::types::IpcError> {
        ...
        crate::log_debug!("Created pipe: id={}, read_fd={}, write_fd={}", id, read_fd, write_fd);
        Ok((read_fd, write_fd))
    }
    ...
    pub fn create_shared_memory(&mut self, size: u64, permissions: crate::syscalls::ipc::types::IpcPermissions, flags: u32) -> Result<u32, crate::syscalls::ipc::types::IpcError> {
        ...
        self.ipc_objects.push(ipc_object);
        crate::log_debug!("Created shared memory: id={}, size={}", id, size);
        Ok(id)
    }
    ...
    pub fn create_message_queue(&mut self, key: i32, permissions: crate::syscalls::ipc::types::IpcPermissions, flags: u32) -> Result<u32, crate::syscalls::ipc::types::IpcError> {
        ...
        self.ipc_objects.push(ipc_object);
        crate::log_debug!("Created message queue: id={}, key={}", id, key);
        Ok(id)
    }
    ...
    pub fn create_semaphore(&mut self, initial_value: u32, permissions: crate::syscalls::ipc::types::IpcPermissions, flags: u32) -> Result<u32, crate::syscalls::ipc::types::IpcError> {
        ...
        self.ipc_objects.push(ipc_object);
        crate::log_debug!("Created semaphore: id={}, initial_value={}", id, initial_value);
        Ok(id)
    }
    ...
    pub fn delete_ipc_object(&mut self, id: u32) -> Result<(), crate::syscalls::ipc::types::IpcError> {
        if let Some(pos) = self.ipc_objects.iter().position(|obj| obj.id == id) {
            ...
            crate::log_debug!("Deleted IPC object: {}", id);
            Ok(())
        } else {
    ...
    pub fn set_ipc_object_permissions(&mut self, id: u32, permissions: crate::syscalls::ipc::types::IpcPermissions) -> Result<(), crate::syscalls::ipc::types::IpcError> {
        if let Some(obj) = self.ipc_objects.iter_mut().find(|obj| obj.id == id) {
            ...
            crate::log_debug!("Set permissions for IPC object {}: {:?}", id, permissions.to_octal());
            Ok(())
        } else {
            Err(crate::syscalls::ipc::types::IpcError::ObjectNotFound)
        }
...
impl SyscallService for IpcService {
    ...
    fn handle_syscall(&mut self, syscall_number: u32, args: &[u64]) -> Result<u64, KernelError> {
        crate::log_debug!("IpcService handling syscall: {}", syscall_number);
...
mod tests {
    ...
    fn test_ipc_service_lifecycle() {
        let mut service = IpcService::new();
    ...
    fn test_pipe_creation() {
        ...
        let (read_fd, write_fd) = service.create_pipe(0).unwrap();
        assert!(read_fd >= 10);
        assert!(write_fd >= 20);
