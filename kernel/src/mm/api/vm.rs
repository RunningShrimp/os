...
use crate::mm::vm::{PageTable, map_pages, VmArea, VmPerm, PAGE_SIZE, flush_tlb_page};
use crate::mm::vm::flags;
...
static VM_MANAGERS_INIT: crate::sync::Once = crate::sync::Once::new();
