...
pub unsafe fn mempool_create(base: *mut u8, size: usize, block_size: usize, alignment: usize) -> Option<usize> {
    if let Some(pool) = MemoryPool::new(base, size, block_size, alignment) {
...
pub fn mempool_alloc_sized(block_size: usize, alignment: usize) -> *mut u8 {
...
pub unsafe fn mempool_dealloc_sized(ptr: *mut u8, block_size: usize) {
