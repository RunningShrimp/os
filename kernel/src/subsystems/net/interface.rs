...
impl Interface {
    ...
    pub fn up(&self) -> Result<(), InterfaceError> {
        ...
        crate::log_info!("Network interface '{}' (ID: {}) is up", self.name.clone(), self.id);
        Ok(())
    }
    ...
    pub fn down(&self) -> Result<(), InterfaceError> {
        ...
        crate::log_info!("Network interface '{}' (ID: {}) is down", self.name.clone(), self.id);
        Ok(())
    }
    ...
    pub fn configure(&mut self, config: &InterfaceConfig) -> Result<(), InterfaceError> {
        ...
        crate::log_info!("Network interface '{}' configured", self.name.clone());
        Ok(())
    }
