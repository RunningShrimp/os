    ...
    fn apply(
        ...
        Ok(OptimizationResult {
            ...
            parameters: {
                ...
                params.insert(
                    alloc::string::String::from("priority"),
                    alloc::string::String::from("high"),
                );
                params
            },
        })
...
impl CachingOptimization {
    pub fn new(priority: u8, min_call_count: u64, cache_ttl_ns: u64) -> Self {
        Self { priority, min_call_count, cache_ttl_ns }
    }
}
    ...
    fn apply(
        ...
        Ok(OptimizationResult {
            ...
            parameters: {
                let mut params = BTreeMap::new();
                params.insert(
                    alloc::string::String::from("ttl_ns"),
                    alloc::format!("{}", self.cache_ttl_ns),
                );
                params
            },
        })
...
impl BatchingOptimization {
    pub fn new(priority: u8, min_consecutive_calls: usize, batch_size: usize) -> Self {
        Self { priority, min_consecutive_calls, batch_size }
    }
}
    ...
    fn apply(
        ...
        Ok(OptimizationResult {
            ...
            parameters: {
                let mut params = BTreeMap::new();
                params.insert(
                    alloc::string::String::from("batch_size"),
                    alloc::format!("{}", self.batch_size),
                );
                params
            },
        })
...
impl UnifiedOptimizationManager {
    ...
    fn record_optimization(
        ...
        before_stats: &UnifiedSyscallStats,
    ) {
        ...
        self.next_optimization_time
            .store(next_time, Ordering::Relaxed);
    }
...
/// 获取全局优化管理器
pub fn get_global_optimization_manager()
-> Option<&'static Mutex<Option<UnifiedOptimizationManager>>> {
