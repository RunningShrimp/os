...
pub extern "C" fn sys_glib_object_set_property(
    ...
    crate::println!(
        "[glib_object] 属性设置成功: instance={}, property={}",
        instance_id,
        property_name
    );
    0
...
pub extern "C" fn sys_glib_object_get_property(
    ...
    if instance_id == 0 || name.is_null() || value.is_null() {
        crate::println!(
            "[glib_object] 无效参数: instance={}, name={:p}, value={:p}",
            instance_id,
            name,
            value
        );
        ...
        match instances.get(&instance_id) {
            Some(instance_info) => {
                match instance_info.properties.get(&property_name) {
                    ...
                    None => {
                        crate::println!(
                            "[glib_object] 属性不存在: instance={}, property={}",
                            instance_id,
                            property_name
                        );
                        return -2; // ENOENT
    ...
    crate::println!(
        "[glib_object] 属性获取成功: instance={}, property={}, value={}",
        instance_id,
        property_name,
        property_value
    );
