...
pub mod memory_tests {
    ...
    pub fn test_kalloc_pages() -> TestResult {
        ...
        unsafe {
            crate::subsystems::mm::kfree(page1);
            crate::subsystems::mm::kfree(pages2);
        }
    ...
    pub fn test_page_address_utilities() -> TestResult {
        ...
        test_assert_eq!(crate::subsystems::mm::page_round_down(0x12345678), 0x12345000);
        test_assert_eq!(crate::subsystems::mm::page_round_down(0x1000), 0x1000);
        test_assert_eq!(crate::subsystems::mm::page_round_down(0x1001), 0x1000);
        test_assert_eq!(crate::subsystems::mm::page_round_down(0x1FFF), 0x1000);

        // Test page_round_up
        test_assert_eq!(crate::subsystems::mm::page_round_up(0x12345678), 0x12346000);
        test_assert_eq!(crate::subsystems::mm::page_round_up(0x1000), 0x1000);
        test_assert_eq!(crate::subsystems::mm::page_round_up(0x1001), 0x2000);
        test_assert_eq!(crate::subsystems::mm::page_round_up(0x1FFF), 0x2000);

        // Test addr_to_pfn and pfn_to_addr
        let addr = 0x12345000;
        let pfn = crate::subsystems::mm::addr_to_pfn(addr);
        let back_to_addr = crate::subsystems::mm::pfn_to_addr(pfn);
    ...
    pub fn test_phys_addr_wrapper() -> TestResult {
        let addr = crate::subsystems::mm::PhysAddr::new(0x12345678);
        ...
        let aligned_addr = crate::subsystems::mm::PhysAddr::new(0x12345000);
    ...
    pub fn test_virt_addr_wrapper() -> TestResult {
        let addr = crate::subsystems::mm::VirtAddr::new(0x12345678);
        ...
        let aligned_addr = crate::subsystems::mm::VirtAddr::new(0x12345000);
        test_assert!(aligned_addr.is_page_aligned());
    ...
    pub fn test_memory_copy_utilities() -> TestResult {
        ...
        // Test memmove
        unsafe {
            crate::subsystems::mm::memmove(dst.as_mut_ptr(), src.as_ptr(), 5);
        }
        ...
        let mut buf = [0u8; 10];
        unsafe {
            crate::subsystems::mm::memset(buf.as_mut_ptr(), 0xAA, 10);
        }
        for &byte in &buf {
        ...
        unsafe {
            test_assert_eq!(crate::subsystems::mm::memcmp(buf1.as_ptr(), buf2.as_ptr(), 5), 0);
            test_assert!(crate::subsystems::mm::memcmp(buf1.as_ptr(), buf3.as_ptr(), 5) < 0);
            test_assert!(crate::subsystems::mm::memcmp(buf3.as_ptr(), buf1.as_ptr(), 5) > 0);
        }
    ...
    pub fn test_memory_statistics() -> TestResult {
        let (free_pages, total_pages) = crate::subsystems::mm::mem_stats();
        ...
        let (free_pages_after, total_pages_after) = crate::subsystems::mm::mem_stats();
    ...
    pub fn test_heap_bounds() -> TestResult {
        let heap_start = crate::subsystems::mm::heap_start();
        let heap_end = crate::subsystems::mm::heap_end();
    ...
    pub fn test_mmio_regions() -> TestResult {
        let regions = crate::subsystems::mm::mmio_regions();
    ...
    pub fn test_mmio_access() -> TestResult {
        ...
        let initial_stats = crate::subsystems::mm::mmio_stats_take();
    ...
    pub fn test_memory_fragmentation() -> TestResult {
        ...
        for _ in 0..5 {
            let pages = crate::subsystems::mm::kalloc_pages(4);
