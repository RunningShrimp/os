//! Mutex implementations for kernel synchronization.
//!
//! This module provides mutex types that protect data with mutual exclusion.
//! Moved from kernel/src/sync to eliminate circular dependencies.
...
use super::{RawSpinLock, SpinLockIrq, SpinLockIrqGuard};
...
impl<T: ?Sized + core::fmt::Debug> core::fmt::Debug for MutexIrq<T> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
