...
fn get_current_time_ns(clock_source: ClockSource) -> u64 {
    match clock_source {
        ClockSource::Realtime => crate::time::get_time_ns(),
        ClockSource::Monotonic => crate::time::get_monotonic_time_ns(),
        ClockSource::Boottime => crate::time::get_boot_time_ns(),
        ClockSource::TAI => crate::time::get_time_ns(), // Fallback to realtime for now
    }
}
