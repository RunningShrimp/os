...
impl UnifiedErrorMapper {
    ...
    pub fn map_unified_error(&self, error: &UnifiedError) -> Errno {
        ...
        match error {
            ...
            UnifiedError::MlError(_) => Errno::EIO,
            UnifiedError::VirtualizationError(_) => Errno::EIO,
            UnifiedError::ContainerError(_) => Errno::EIO,
            UnifiedError::DeviceError(_) => Errno::EIO,
            UnifiedError::SnapshotError(_) => Errno::EIO,
            UnifiedError::ClusterError(_) => Errno::EIO,
