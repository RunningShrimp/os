...
pub fn run_tests() -> crate::common::TestResult {
    ...
    let total = 5; // test_fchmod_permission_check, test_fchown_permission_check, test_chmod_permission_check, test_chown_permission_check, test_permission_error_handling
