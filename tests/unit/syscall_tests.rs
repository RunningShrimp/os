...
use nos_syscalls::common::{SyscallError, syscall_error_to_errno};
...
pub fn run_tests() -> crate::common::TestResult {
    ...
    let total = 19; // error_handling_tests:4, dispatch_tests:3, consistency_tests:2, argument_tests:3, epoll_tests:4, filesystem_tests:3
...
mod syscall_argument_tests {
    ...
    fn test_argument_extraction() {
        use nos_syscalls::common::extract_args;
