...
use nos_syscalls::process::manager::{ProcTable, ProcState};
use crate::common::TestSuite;

/// Process test suite implementation
pub struct ProcessTestSuite;

impl TestSuite for ProcessTestSuite {
    fn run_tests(&self) -> crate::common::TestResult {
        // Count all the tests in this file
        let total = 14; // 5 in allocation, 2 in lookup, 2 in lifecycle, 1 in error, 4 in parent-child
