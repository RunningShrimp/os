...
/// These define the system call numbers used by the kernel
pub mod syscall_numbers {
    // Process management syscalls
    pub const SYS_FORK: u32 = 0x1000;
    pub const SYS_EXECVE: u32 = 0x1001;
    pub const SYS_WAITPID: u32 = 0x1002;
    ...
    pub const SYS_GETPID_STD: u32 = 39;
    ...
    pub const SYS_FORK_STD: u32 = 57;
    pub const SYS_VFORK: u32 = 58;
    pub const SYS_EXECVE_STD: u32 = 59;
    pub const SYS_EXIT_STD: u32 = 60;
    ...
    pub const SYS_GETPPID_STD: u32 = 110;
