...
impl TestRunner {
    ...
    pub fn new() -> Self {
        Self { suites: BTreeMap::new(), stats: TestRunnerStats::new() }
    }
...
impl SyscallTestCase {
    ...
    pub fn new(name: String, description: String, syscall_id: u32, args: Vec<usize>) -> Self {
        Self {
            name,
            description,
            syscall_id,
    ...
    fn run(&self) -> TestResult {
        ...
        let result = {
            ...
            match self.syscall_id {
                ...
                _ => Err(nos_api::Error::NotFound(format!(
...
pub fn create_standard_test_suites() -> Vec<Arc<TestSuite>> {
    ...
    // Network test suite
    let mut net_suite =
        TestSuite::new("Network Tests".to_string(), "Tests for network operations".to_string());

    net_suite.add_test(Box::new(
        SyscallTestCase::new(
